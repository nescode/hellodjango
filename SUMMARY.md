...
* [How to create project and apps](django_project_apps.md)
* [Files and folder structure](django_files_folder.md)
* [Request and response](django_request_response.md)
* [Model and admin site](django_model_admin.md)
* [CRUD](crud.md)
* [View and templates](django_views_templates.md)
* [Template context and template inheritance](django_template_context_inheritance.md)
* [Queryset basics](django_queryset.md)
* [Dynamic URL and routing patterns](django_url_patterns.md)
